 ...
 */
final class Version20241111170147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id SERIAL NOT NULL, associated_user_id INT NOT NULL, class_room_id INT NOT NULL, contact_parent VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
